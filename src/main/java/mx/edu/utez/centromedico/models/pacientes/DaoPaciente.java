...
public class DaoPaciente {
    ...
    public void actualizarPaciente(int idPaciente, String nombre, String apellidoPaterno, String apellidoMaterno, java.sql.Date fechaNacimiento, String padecimientos, String receta) {
        try {
            conn = new MySQLConnection().connect();
